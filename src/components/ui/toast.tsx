...
>(
  (
    ...
    switch (variant) {
      case "success":
        title = "Success",
          className = "border-toast-success";
        Icon = (
          <RiCheckboxCircleFill
      ...
      case "warning":
        title = "Warning",
          className = "border-toast-warning";
        Icon = (
          <RiErrorWarningFill
    ...
    return (
      <ToastPrimitives.Root
        ...
        className={cx(
          // base
          "flex h-fit max-w-[320px] w-full overflow-hidden shadow-xl",
          // background color
          "bg-gradient",
          // border color
          " ",
          ...
          <div className="flex flex-col gap-1">
            ...
            {action && (
              <a
                ...
                className={cx(
                  // base
                  "text-start text-sm font-medium text-slate-500 flex inline"
                )}
              >
                {action.label}
                <svg className="flex inline-flex ml-[8px] fill-slate-500" width="13" height="13" viewBox="0 0 19 19" xmlns="http://www.w3.org/2000/svg" >
